...
<img src="md_media/Y1-实践详情 副本/media/image1.png" style="width:5.75in;height:2.63542in" />

为不同合同指定合同类型并配置适用的审核规则

<img src="md_media/Y1-实践详情 副本/media/image2.png" style="width:5.75in;height:2.58333in" />

触发合同审核工作流，自动执行规则化审查

在前端查看审核结果并进行人工复核与批注

<img src="md_media/Y1-实践详情 副本/media/image3.png" style="width:5.75in;height:2.75in" />

输出带风险标注的审核结果文件

<img src="md_media/Y1-实践详情 副本/media/image4.png" style="width:5.75in;height:2.58333in" />
